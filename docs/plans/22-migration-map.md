...
| `quoteBinary()` | per-driver | `QuotingInterface::quoteBinary()` | `SQLCraft\Contracts\Platform` | Same method name/signature across all 6 platforms |
