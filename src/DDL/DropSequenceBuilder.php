...
final readonly class DropSequenceBuilder implements DdlBuilderInterface, \SQLCraft\Contracts\DDL\ObjectNameAwareDdlBuilderInterface
{
    ...
    {
        return [$dialect->renderDropSequenceStatement($this->name, $this->ifExists)];
    }
