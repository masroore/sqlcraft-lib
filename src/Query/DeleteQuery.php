...
{
    /** @param list<WhereCondition> $where */ public function __construct(public QualifiedName $table, /** @var list<WhereCondition> */ public array $where = [], public ?int $limit = null)
    {
    }
