...
{
    public function testDescribeTableHydratesColumnsIndexesForeignKeysTriggersAndStatus(): void
    {
    ...
    public function testBatchColumnsUseOneCrossTableQueryAndReturnTypedCollections(): void
    {
        $connection = $this->connection();
    ...
    public function testUnsupportedSequenceInspectionIsExplicit(): void
    {
        $connection = $this->connection();
