...
final class PlatformContractsTest extends TestCase
{
    public function testSegregatedPlatformPortsExposeThePlannedMethods(): void
    {
        ...
        self::assertSame(['getDatabasesSql', 'getTablesSql', 'getColumnsSql', 'getIndexesSql', 'getForeignKeysSql', 'getTriggersSql', 'getRoutinesSql', 'getSequencesSql', 'getVariablesSql', 'getProcesslistSql'], $this->methods(IntrospectionDialectInterface::class));
