...
final class PlatformContractsTest extends TestCase
{
    public function testSegregatedPlatformPortsExposeThePlannedMethods(): void
    {
        ...
        self::assertSame(['getDatabasesSql', 'getTablesSql', 'getColumnsSql', 'getTableStatusSql', 'getParentTablesSql', 'getPartitionsSql', 'getIndexesSql', 'getForeignKeysSql', 'getReferencingForeignKeysSql', 'getTriggersSql', 'getRoutinesSql', 'getSequencesSql', 'getVariablesSql', 'getProcesslistSql'], $this->methods(IntrospectionDialectInterface::class));
