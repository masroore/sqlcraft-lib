...
{
    public function testHydratesPostgreSqlColumnAndSequenceDefault(): void
    {
    ...
    public function testHydratesPostgreSqlIndexAndForeignKey(): void
    {
    ...
    public function testHydratesPostgreSqlRoutineAndTableStatus(): void
    {
        $factory = new PostgreSQLMetadataFactory();
