...
{
    public function testFactoryDispatchesOpenedAndCloseEventsWithoutCredentials(): void
    {
    ...
    public function testFactoryDispatchesFailureEvent(): void
    {
        $provider = new SimpleListenerProvider();
        $failed = null;
    ...
    public function testConnectionOpeningCanBeCancelledBeforePdoCreation(): void
    {
        $provider = new SimpleListenerProvider();
    ...
    public function testTransactionLifecycleEventsIncludeSavepointData(): void
    {
        $provider = new SimpleListenerProvider();
        $received = [];
