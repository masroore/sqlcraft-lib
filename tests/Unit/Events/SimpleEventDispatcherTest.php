...
{
    public function testItDispatchesMatchingListenersByPriorityAndRegistrationOrder(): void
    {
    ...
    public function testItSupportsInterfaceSubscriptions(): void
    {
        $provider = new SimpleListenerProvider();
        $called = false;
    ...
    public function testItStopsPropagationBeforeTheNextListener(): void
    {
        $provider = new SimpleListenerProvider();
        $events = [];
